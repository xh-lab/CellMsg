...
interaction_ = pd.read_csv("/home/jby2/XH/CellMsg/dataset1/ligand-receptor-interaction.csv", header=None, index_col=None).to_numpy()
...
model = GCN_MLP()
model.load_state_dict(torch.load("/home/jby2/XH/CellMsg/dataset1/final_model.pth"))
...
# predicting
    ...
    for i, j in tqdm(enumerate(outputs), total=outputs.shape[0]):
        if j >= 0.999:
            with open('/home/jby2/XH/CellMsg/dataset1/generation/confidence_lr_ensp.csv', 'a') as file:
