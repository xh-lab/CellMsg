...
columns_to_read = [2, 4]
LRI_connectome = pd.read_csv("/home/jby2/XH/CCC_compare_DB/Connectome/mouse_lr.csv", usecols=columns_to_read, header=0)
...
with open("/home/jby2/XH/CellMsg/dataset2/CCCDB_compare/compare_connectome.txt", mode="a") as f:
