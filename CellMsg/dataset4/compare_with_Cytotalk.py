...
columns_to_read = [1, 2]
LRI_cytotalk = pd.read_csv("/home/jby2/XH/CCC_compare_DB/Cytotalk/lrp_human.csv", usecols=columns_to_read, header=0)
...
with open("/home/jby2/XH/CellMsg/dataset4/CCCDB_compare/compare_cytotalk.txt", mode="a") as f:
