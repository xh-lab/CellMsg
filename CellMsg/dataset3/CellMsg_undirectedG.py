...
for fold, (train_index, test_index) in enumerate(kf.split(sample, label)):
    ...
    with torch.no_grad():
        ...
        with open("/home/jby2/XH/CellMsg/dataset3/five-fold-cross-val-undirected/value_of_" + str(fold) + ".txt", mode="a") as f:
        ...
        directory = '/home/jby2/XH/CellMsg/dataset3/five-fold-cross-val-undirected/roc/'
        ...
        df = pd.DataFrame(data)
        directory = '/home/jby2/XH/CellMsg/dataset3/five-fold-cross-val-undirected/prc/'
        #if not os.path.exists(directory):
            # create directory
            #os.makedirs(directory)
        df.to_csv(directory + str(fold) + ".csv", index=False)
...
with open("/home/jby2/XH/CellMsg/dataset3/five-fold-cross-val-undirected/mean_value_of_five-fold_cross-validation.txt", mode="a") as f:
    f.write("precision:{}\n".format(precision_kt))
    f.write("recall:{}\n".format(recall_kt))
    f.write("acc:{}\n".format(acc_kt))
    f.write("f1:{}\n".format(f1_kt))
