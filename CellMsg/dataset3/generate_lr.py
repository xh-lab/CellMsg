...
interaction_ = pd.read_csv("/home/jby2/XH/CellMsg/dataset3/ligand-receptor-interaction.csv", header=None, index_col=None).to_numpy()
...
model = GCN_MLP()
model.load_state_dict(torch.load("/home/jby2/XH/CellMsg/dataset3/final_model.pth"))
...
# predicting
    ...
    for i, j in tqdm(enumerate(outputs), total=outputs.shape[0]):
        if j >= 0.999:
            with open('/home/jby2/XH/CellMsg/dataset3/generation/confidence_lr_ens.csv', 'a') as file:
